...
# test storage
# flow-c1 transactions send --network=previewnet --gas-limit=9999 --signer=preview ./cadence/transactions/create_account.cdc 935c983f95f8b871b7071442ef614c6d3295a5fffd0e0fb2b9fac11da88638d20526822f2f3f7881f2618af00d784a90292ceed8a9ccc6ae346890d1283df9da 1 3 1000.0
# flow-c1 transactions send --network=previewnet --gas-limit=9999 --signer=pre1 ./cadence/transactions/set_up_ghost.cdc

# for i in {1..10}
# do
#     echo "Sending transaction $i"
#     flow-c1 transactions send --network=previewnet --gas-limit=9999 --signer=pre1 ./cadence/transactions/create_account_and_grant_auth.cdc 935c983f95f8b871b7071442ef614c6d3295a5fffd0e0fb2b9fac11da88638d20526822f2f3f7881f2618af00d784a90292ceed8a9ccc6ae346890d1283df9da 1 3 1000.0
# done